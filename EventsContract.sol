...
// When a transaction is sent over the network, the state of the contract can change
// When the state changes,you can emit events 
// The DAPP can watch for these events 
// Written using the event keyword
