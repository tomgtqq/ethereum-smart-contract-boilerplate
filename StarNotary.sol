...
contract StarNotary  {
    ...
    string public constant name = "SuperStar Token";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        string memory _name = _star.name;
        return _name;
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1Address||msg.sender == owner2Address ,"Only Star's owner can exchange this Star");
